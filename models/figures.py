...
gen_wgan=Generator_Lz2(z_dim=z_ns)
...
gen_mmd.load_state_dict(torch.load(f='../checkpoints/MMD_9900_12-10-2022-08-04-44.pt', map_location='cpu'))
gen_wgan.load_state_dict(torch.load(f='../checkpoints/NS_final_12-10-2022-07-47-56.pt', map_location='cpu'))
#Testing
noise_dist = "gaussian"
noise_param = (0., 1.)
...
#WGAN
noise_mmd = data_sampler2(noise_dist, noise_param, (100000,z_wgan))
transformed_noise_wgan= gen_wgan.forward(noise_mmd)
...
df['Generated WGAN']=pd.Series(transformed_noise_ns.flatten())
...
fig=sns.kdeplot(df['Generated WGAN'], shade=False, color='b')
plt.legend(labels=["Actual","Generated MMD", "Generated NS",'Generated WGAN'])
plt.xlabel("")
plt.show()
